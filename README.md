...
- Node.js instalado
- Clonar e executar a [API](https://github.com/danielleblima/banco-api) e a [aplicação Web](https://github.com/danielleblima/banco-web)

## Instalação

1. Clone este repositório:
   ```bash
   git clone https://github.com/danielleblima/banco-api-tests.git
   cd banco-web-tests
   ```
